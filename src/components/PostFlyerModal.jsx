    ...
    >
      <div id="modalBackdrop" className="backdrop-brightness-50 flex h-full w-full inset-0 bg-opacity-50 justify-center items-center z-9910 backdrop-blur-md">
        <div className="bg-stone-50 dark:bg-gray-800 rounded-lg w-2/3 lg:w-1/3  z-9920">
          ...
          <div className="border-b border-stone-200 dark:border-gray-700 p-4 flex flex-col items-center gap-2 text-sm antialiased font-sans text-left">
          ...
          <div className="p-4">
            <div className="space-y-2">
              <a href={smsLink} className="cursor-pointer inline-flex w-full gap-2 items-center justify-center border align-middle text-center text-sm py-2 px-4 shadow-sm bg-stone-200 relative border-stone-200 text-stone-700 rounded-lg">
                ...
                <p className="font-sans text-base text-inherit font-semibold">Send Image with SMS</p>
              </a>
              <a href={emailLink} className="cursor-pointer inline-flex w-full gap-2 items-center justify-center border align-middle text-center text-sm py-2 px-4 shadow-sm bg-stone-200 relative border-stone-200 text-stone-700 rounded-lg">
                <svg className="w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="font-sans text-base text-inherit font-semibold">Send Image with Email</p>
              </a>
            </div>
          </div>
